      ...
      <g clip-path="url(#clip0_2950_272)">
        ...
        <g mask="url(#mask0_2950_272)">
          ...
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M10.5021 9.83L8.41207 10.93L8.81207 8.603L7.12207 6.956L9.45807 6.616L10.5021 4.5L11.5471 6.616L13.8821 6.956L12.1921 8.603L12.5921 10.929"
            fill="#FFFF00"
          />
          <path
